...
class RegistrationsController < ApplicationController
  ...
  def create
    ...
    if @user.save
      ...
      @message = @chat.messages.create(user_id: @chatbot.id, chat_id: @chat.id,
                                       content: "Hey there! welcome to our chat! I'm here to help and chat with you. How can I assist you today?")
